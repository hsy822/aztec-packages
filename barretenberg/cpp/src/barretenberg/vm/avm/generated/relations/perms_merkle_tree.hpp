...
class perm_merkle_poseidon2_permutation_settings {
  public:
    ...
    {
        return (in.get_merkle_tree_sel_merkle_tree() == 1 || in.get_poseidon2_full_sel_merkle_tree() == 1);
    }

    template <typename AllEntities> static inline auto get_const_entities(const AllEntities& in)
    {
        return std::forward_as_tuple(in.get_perm_merkle_poseidon2_inv(),
                                     in.get_merkle_tree_sel_merkle_tree(),
                                     in.get_merkle_tree_sel_merkle_tree(),
                                     in.get_poseidon2_full_sel_merkle_tree(),
                                     in.get_merkle_tree_clk(),
                                     in.get_merkle_tree_left_hash(),
                                     in.get_merkle_tree_right_hash(),
                                     in.get_merkle_tree_output_hash(),
                                     in.get_poseidon2_full_clk(),
                                     in.get_poseidon2_full_input_0(),
                                     in.get_poseidon2_full_input_1(),
                                     in.get_poseidon2_full_output());
    }
