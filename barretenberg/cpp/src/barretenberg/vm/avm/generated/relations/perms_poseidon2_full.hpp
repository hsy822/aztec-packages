...
class perm_pos2_fixed_pos2_perm_permutation_settings {
  public:
    ...
    {
        return (in.get_poseidon2_full_sel_poseidon() == 1 || in.get_poseidon2_sel_poseidon_perm_immediate() == 1);
    }

    template <typename AllEntities> static inline auto get_const_entities(const AllEntities& in)
    {
        return std::forward_as_tuple(in.get_perm_pos2_fixed_pos2_perm_inv(),
                                     in.get_poseidon2_full_sel_poseidon(),
                                     in.get_poseidon2_full_sel_poseidon(),
                                     in.get_poseidon2_sel_poseidon_perm_immediate(),
                                     in.get_poseidon2_full_clk(),
                                     in.get_poseidon2_full_a_0(),
                                     in.get_poseidon2_full_a_1(),
                                     in.get_poseidon2_full_a_2(),
                                     in.get_poseidon2_full_a_3(),
                                     in.get_poseidon2_full_b_0(),
                                     in.get_poseidon2_full_b_1(),
                                     in.get_poseidon2_full_b_2(),
                                     in.get_poseidon2_full_b_3(),
