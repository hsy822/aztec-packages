...
class incl_main_tag_err_lookup_settings {
  public:
    ...
    {
        return (in.get_mem_tag_err() == 1 || in.get_main_tag_err() == 1);
    }
    ...
    static inline auto compute_inverse_exists(const AllEntities& in)
    {
        ...
        const auto is_operation = View(in.get_mem_tag_err());
        const auto is_table_entry = View(in.get_main_tag_err());
    ...
    {
        return std::forward_as_tuple(in.get_incl_main_tag_err_inv(),
                                     in.get_incl_main_tag_err_counts(),
                                     in.get_mem_tag_err(),
                                     in.get_main_tag_err(),
                                     in.get_mem_clk(),
                                     in.get_main_clk());
...
class incl_mem_tag_err_lookup_settings {
  public:
    ...
    template <typename AllEntities> static inline auto inverse_polynomial_is_computed_at_row(const AllEntities& in)
    {
        return (in.get_main_tag_err() == 1 || in.get_mem_tag_err() == 1);
    }
    ...
    {
        using View = typename Accumulator::View;
        const auto is_operation = View(in.get_main_tag_err());
        const auto is_table_entry = View(in.get_mem_tag_err());
        return (is_operation + is_table_entry - is_operation * is_table_entry);
    }
    ...
    template <typename AllEntities> static inline auto get_entities(AllEntities&& in)
    {
        return std::forward_as_tuple(in.get_incl_mem_tag_err_inv(),
                                     in.get_incl_mem_tag_err_counts(),
                                     in.get_main_tag_err(),
                                     in.get_mem_tag_err(),
                                     in.get_main_clk(),
                                     in.get_mem_clk());
