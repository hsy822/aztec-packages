...
class lookup_byte_lengths_lookup_settings {
  public:
    ...
    {
        return (in.get_binary_start() == 1 || in.get_byte_lookup_sel_bin() == 1);
    }
    ...
    static inline auto compute_inverse_exists(const AllEntities& in)
    {
        ...
        const auto is_operation = View(in.get_binary_start());
        const auto is_table_entry = View(in.get_byte_lookup_sel_bin());
    ...
    {
        return std::forward_as_tuple(in.get_lookup_byte_lengths_inv(),
                                     in.get_lookup_byte_lengths_counts(),
                                     in.get_binary_start(),
                                     in.get_byte_lookup_sel_bin(),
                                     in.get_binary_in_tag(),
                                     in.get_binary_mem_tag_ctr(),
                                     in.get_byte_lookup_table_in_tags(),
                                     in.get_byte_lookup_table_byte_lengths());
    }
};
...
class lookup_byte_operations_lookup_settings {
  public:
    ...
    template <typename AllEntities> static inline auto inverse_polynomial_is_computed_at_row(const AllEntities& in)
    {
        return (in.get_binary_sel_bin() == 1 || in.get_byte_lookup_sel_bin() == 1);
    }
    ...
    {
        using View = typename Accumulator::View;
        const auto is_operation = View(in.get_binary_sel_bin());
        const auto is_table_entry = View(in.get_byte_lookup_sel_bin());
        return (is_operation + is_table_entry - is_operation * is_table_entry);
    }
    ...
    template <typename AllEntities> static inline auto get_entities(AllEntities&& in)
    {
        return std::forward_as_tuple(in.get_lookup_byte_operations_inv(),
                                     in.get_lookup_byte_operations_counts(),
                                     in.get_binary_sel_bin(),
                                     in.get_byte_lookup_sel_bin(),
                                     in.get_binary_op_id(),
                                     in.get_binary_ia_bytes(),
                                     in.get_binary_ib_bytes(),
                                     in.get_binary_ic_bytes(),
                                     in.get_byte_lookup_table_op_id(),
                                     in.get_byte_lookup_table_input_a(),
                                     in.get_byte_lookup_table_input_b(),
                                     in.get_byte_lookup_table_output());
    }
};
