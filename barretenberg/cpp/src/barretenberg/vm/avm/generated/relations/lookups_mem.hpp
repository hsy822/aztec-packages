...
class lookup_mem_rng_chk_0_lookup_settings {
  public:
    ...
    {
        return (in.get_mem_sel_rng_chk() == 1 || in.get_main_sel_rng_16() == 1);
    }
    ...
    static inline auto compute_inverse_exists(const AllEntities& in)
    {
        ...
        const auto is_operation = View(in.get_mem_sel_rng_chk());
    ...
    {
        return std::forward_as_tuple(in.get_lookup_mem_rng_chk_0_inv(),
                                     in.get_lookup_mem_rng_chk_0_counts(),
                                     in.get_mem_sel_rng_chk(),
...
class lookup_mem_rng_chk_1_lookup_settings {
  public:
    ...
    template <typename AllEntities> static inline auto get_entities(AllEntities&& in)
    {
        return std::forward_as_tuple(in.get_lookup_mem_rng_chk_1_inv(),
                                     in.get_lookup_mem_rng_chk_1_counts(),
                                     in.get_mem_sel_rng_chk(),
                                     in.get_main_sel_rng_16(),
                                     in.get_mem_u16_r1(),
                                     in.get_main_clk());
...
class lookup_mem_rng_chk_2_lookup_settings {
  public:
    ...
    template <typename AllEntities> static inline auto inverse_polynomial_is_computed_at_row(const AllEntities& in)
    {
        return (in.get_mem_sel_rng_chk() == 1 || in.get_main_sel_rng_8() == 1);
    }
    ...
    template <typename AllEntities> static inline auto get_entities(AllEntities&& in)
    {
        return std::forward_as_tuple(in.get_lookup_mem_rng_chk_2_inv(),
                                     in.get_lookup_mem_rng_chk_2_counts(),
                                     in.get_mem_sel_rng_chk(),
