...
class perm_pos_mem_read_a_permutation_settings {
  public:
    ...
    {
        return (in.get_poseidon2_sel_poseidon_perm_mem_op() == 1 || in.get_mem_sel_op_poseidon_read_a() == 1);
    }

    template <typename AllEntities> static inline auto get_const_entities(const AllEntities& in)
    {
        return std::forward_as_tuple(in.get_perm_pos_mem_read_a_inv(),
                                     in.get_poseidon2_sel_poseidon_perm_mem_op(),
                                     in.get_poseidon2_sel_poseidon_perm_mem_op(),
                                     in.get_mem_sel_op_poseidon_read_a(),
                                     in.get_poseidon2_clk(),
                                     in.get_poseidon2_space_id(),
                                     in.get_poseidon2_mem_addr_read_a(),
                                     in.get_poseidon2_a_0(),
                                     in.get_main_zeroes(),
                                     in.get_mem_clk(),
                                     in.get_mem_space_id(),
                                     in.get_mem_addr(),
...
class perm_pos_mem_read_b_permutation_settings {
  public:
    ...
    template <typename AllEntities> static inline auto inverse_polynomial_is_computed_at_row(const AllEntities& in)
    {
        return (in.get_poseidon2_sel_poseidon_perm_mem_op() == 1 || in.get_mem_sel_op_poseidon_read_b() == 1);
    }

    template <typename AllEntities> static inline auto get_const_entities(const AllEntities& in)
    {
        return std::forward_as_tuple(in.get_perm_pos_mem_read_b_inv(),
                                     in.get_poseidon2_sel_poseidon_perm_mem_op(),
                                     in.get_poseidon2_sel_poseidon_perm_mem_op(),
                                     in.get_mem_sel_op_poseidon_read_b(),
                                     in.get_poseidon2_clk(),
                                     in.get_poseidon2_space_id(),
                                     in.get_poseidon2_mem_addr_read_b(),
                                     in.get_poseidon2_a_1(),
                                     in.get_main_zeroes(),
                                     in.get_mem_clk(),
                                     in.get_mem_space_id(),
                                     in.get_mem_addr(),
...
class perm_pos_mem_read_c_permutation_settings {
  public:
    ...
    template <typename AllEntities> static inline auto inverse_polynomial_is_computed_at_row(const AllEntities& in)
    {
        return (in.get_poseidon2_sel_poseidon_perm_mem_op() == 1 || in.get_mem_sel_op_poseidon_read_c() == 1);
    }

    template <typename AllEntities> static inline auto get_const_entities(const AllEntities& in)
    {
        return std::forward_as_tuple(in.get_perm_pos_mem_read_c_inv(),
                                     in.get_poseidon2_sel_poseidon_perm_mem_op(),
                                     in.get_poseidon2_sel_poseidon_perm_mem_op(),
                                     in.get_mem_sel_op_poseidon_read_c(),
                                     in.get_poseidon2_clk(),
                                     in.get_poseidon2_space_id(),
                                     in.get_poseidon2_mem_addr_read_c(),
                                     in.get_poseidon2_a_2(),
                                     in.get_main_zeroes(),
                                     in.get_mem_clk(),
                                     in.get_mem_space_id(),
                                     in.get_mem_addr(),
...
class perm_pos_mem_read_d_permutation_settings {
  public:
    ...
    template <typename AllEntities> static inline auto inverse_polynomial_is_computed_at_row(const AllEntities& in)
    {
        return (in.get_poseidon2_sel_poseidon_perm_mem_op() == 1 || in.get_mem_sel_op_poseidon_read_d() == 1);
    }

    template <typename AllEntities> static inline auto get_const_entities(const AllEntities& in)
    {
        return std::forward_as_tuple(in.get_perm_pos_mem_read_d_inv(),
                                     in.get_poseidon2_sel_poseidon_perm_mem_op(),
                                     in.get_poseidon2_sel_poseidon_perm_mem_op(),
                                     in.get_mem_sel_op_poseidon_read_d(),
                                     in.get_poseidon2_clk(),
                                     in.get_poseidon2_space_id(),
                                     in.get_poseidon2_mem_addr_read_d(),
                                     in.get_poseidon2_a_3(),
                                     in.get_main_zeroes(),
                                     in.get_mem_clk(),
                                     in.get_mem_space_id(),
                                     in.get_mem_addr(),
...
class perm_pos_mem_write_a_permutation_settings {
  public:
    ...
    template <typename AllEntities> static inline auto inverse_polynomial_is_computed_at_row(const AllEntities& in)
    {
        return (in.get_poseidon2_sel_poseidon_perm_mem_op() == 1 || in.get_mem_sel_op_poseidon_write_a() == 1);
    }

    template <typename AllEntities> static inline auto get_const_entities(const AllEntities& in)
    {
        return std::forward_as_tuple(in.get_perm_pos_mem_write_a_inv(),
                                     in.get_poseidon2_sel_poseidon_perm_mem_op(),
                                     in.get_poseidon2_sel_poseidon_perm_mem_op(),
                                     in.get_mem_sel_op_poseidon_write_a(),
                                     in.get_poseidon2_clk(),
                                     in.get_poseidon2_space_id(),
                                     in.get_poseidon2_mem_addr_write_a(),
                                     in.get_poseidon2_b_0(),
...
class perm_pos_mem_write_b_permutation_settings {
  public:
    ...
    template <typename AllEntities> static inline auto inverse_polynomial_is_computed_at_row(const AllEntities& in)
    {
        return (in.get_poseidon2_sel_poseidon_perm_mem_op() == 1 || in.get_mem_sel_op_poseidon_write_b() == 1);
    }

    template <typename AllEntities> static inline auto get_const_entities(const AllEntities& in)
    {
        return std::forward_as_tuple(in.get_perm_pos_mem_write_b_inv(),
                                     in.get_poseidon2_sel_poseidon_perm_mem_op(),
                                     in.get_poseidon2_sel_poseidon_perm_mem_op(),
                                     in.get_mem_sel_op_poseidon_write_b(),
                                     in.get_poseidon2_clk(),
                                     in.get_poseidon2_space_id(),
                                     in.get_poseidon2_mem_addr_write_b(),
                                     in.get_poseidon2_b_1(),
                                     in.get_poseidon2_sel_poseidon_perm(),
                                     in.get_mem_clk(),
                                     in.get_mem_space_id(),
                                     in.get_mem_addr(),
...
class perm_pos_mem_write_c_permutation_settings {
  public:
    ...
    template <typename AllEntities> static inline auto inverse_polynomial_is_computed_at_row(const AllEntities& in)
    {
        return (in.get_poseidon2_sel_poseidon_perm_mem_op() == 1 || in.get_mem_sel_op_poseidon_write_c() == 1);
    }

    template <typename AllEntities> static inline auto get_const_entities(const AllEntities& in)
    {
        return std::forward_as_tuple(in.get_perm_pos_mem_write_c_inv(),
                                     in.get_poseidon2_sel_poseidon_perm_mem_op(),
                                     in.get_poseidon2_sel_poseidon_perm_mem_op(),
                                     in.get_mem_sel_op_poseidon_write_c(),
                                     in.get_poseidon2_clk(),
                                     in.get_poseidon2_space_id(),
                                     in.get_poseidon2_mem_addr_write_c(),
                                     in.get_poseidon2_b_2(),
                                     in.get_poseidon2_sel_poseidon_perm(),
                                     in.get_mem_clk(),
                                     in.get_mem_space_id(),
                                     in.get_mem_addr(),
...
class perm_pos_mem_write_d_permutation_settings {
  public:
    ...
    template <typename AllEntities> static inline auto inverse_polynomial_is_computed_at_row(const AllEntities& in)
    {
        return (in.get_poseidon2_sel_poseidon_perm_mem_op() == 1 || in.get_mem_sel_op_poseidon_write_d() == 1);
    }

    template <typename AllEntities> static inline auto get_const_entities(const AllEntities& in)
    {
        return std::forward_as_tuple(in.get_perm_pos_mem_write_d_inv(),
                                     in.get_poseidon2_sel_poseidon_perm_mem_op(),
                                     in.get_poseidon2_sel_poseidon_perm_mem_op(),
                                     in.get_mem_sel_op_poseidon_write_d(),
                                     in.get_poseidon2_clk(),
                                     in.get_poseidon2_space_id(),
                                     in.get_poseidon2_mem_addr_write_d(),
                                     in.get_poseidon2_b_3(),
                                     in.get_poseidon2_sel_poseidon_perm(),
                                     in.get_mem_clk(),
                                     in.get_mem_space_id(),
                                     in.get_mem_addr(),
