...
class lookup_rng_chk_pow_2_lookup_settings {
  public:
    ...
    {
        return (in.get_range_check_sel_rng_chk() == 1 || in.get_main_sel_rng_8() == 1);
    }
    ...
    static inline auto compute_inverse_exists(const AllEntities& in)
    {
        ...
        const auto is_operation = View(in.get_range_check_sel_rng_chk());
        const auto is_table_entry = View(in.get_main_sel_rng_8());
    ...
    {
        return std::forward_as_tuple(in.get_lookup_rng_chk_pow_2_inv(),
                                     in.get_lookup_rng_chk_pow_2_counts(),
                                     in.get_range_check_sel_rng_chk(),
                                     in.get_main_sel_rng_8(),
                                     in.get_range_check_dyn_rng_chk_bits(),
                                     in.get_range_check_dyn_rng_chk_pow_2(),
                                     in.get_main_clk(),
                                     in.get_powers_power_of_2());
    }
};
...
class lookup_rng_chk_diff_lookup_settings {
  public:
    ...
    template <typename AllEntities> static inline auto inverse_polynomial_is_computed_at_row(const AllEntities& in)
    {
        return (in.get_range_check_sel_rng_chk() == 1 || in.get_main_sel_rng_16() == 1);
    }
    ...
    static inline auto compute_inverse_exists(const AllEntities& in)
    {
        using View = typename Accumulator::View;
        const auto is_operation = View(in.get_range_check_sel_rng_chk());
        const auto is_table_entry = View(in.get_main_sel_rng_16());
        return (is_operation + is_table_entry - is_operation * is_table_entry);
    }
    ...
    template <typename AllEntities> static inline auto get_entities(AllEntities&& in)
    {
        return std::forward_as_tuple(in.get_lookup_rng_chk_diff_inv(),
                                     in.get_lookup_rng_chk_diff_counts(),
                                     in.get_range_check_sel_rng_chk(),
                                     in.get_main_sel_rng_16(),
                                     in.get_range_check_dyn_diff(),
                                     in.get_main_clk());
    }
};
...
class lookup_rng_chk_0_lookup_settings {
  public:
    ...
    template <typename AllEntities> static inline auto inverse_polynomial_is_computed_at_row(const AllEntities& in)
    {
        return (in.get_range_check_sel_lookup_0() == 1 || in.get_main_sel_rng_16() == 1);
    }
    ...
    {
        using View = typename Accumulator::View;
        const auto is_operation = View(in.get_range_check_sel_lookup_0());
        const auto is_table_entry = View(in.get_main_sel_rng_16());
        return (is_operation + is_table_entry - is_operation * is_table_entry);
    }
    ...
    template <typename AllEntities> static inline auto get_entities(AllEntities&& in)
    {
        return std::forward_as_tuple(in.get_lookup_rng_chk_0_inv(),
                                     in.get_lookup_rng_chk_0_counts(),
                                     in.get_range_check_sel_lookup_0(),
                                     in.get_main_sel_rng_16(),
                                     in.get_range_check_u16_r0(),
                                     in.get_main_clk());
    }
};
...
class lookup_rng_chk_1_lookup_settings {
  public:
    ...
    template <typename AllEntities> static inline auto inverse_polynomial_is_computed_at_row(const AllEntities& in)
    {
        return (in.get_range_check_sel_lookup_1() == 1 || in.get_main_sel_rng_16() == 1);
    }
    ...
    {
        using View = typename Accumulator::View;
        const auto is_operation = View(in.get_range_check_sel_lookup_1());
        const auto is_table_entry = View(in.get_main_sel_rng_16());
        return (is_operation + is_table_entry - is_operation * is_table_entry);
    }
    ...
    template <typename AllEntities> static inline auto get_entities(AllEntities&& in)
    {
        return std::forward_as_tuple(in.get_lookup_rng_chk_1_inv(),
                                     in.get_lookup_rng_chk_1_counts(),
                                     in.get_range_check_sel_lookup_1(),
                                     in.get_main_sel_rng_16(),
                                     in.get_range_check_u16_r1(),
                                     in.get_main_clk());
    }
};
...
class lookup_rng_chk_2_lookup_settings {
  public:
    ...
    template <typename AllEntities> static inline auto inverse_polynomial_is_computed_at_row(const AllEntities& in)
    {
        return (in.get_range_check_sel_lookup_2() == 1 || in.get_main_sel_rng_16() == 1);
    }
    ...
    {
        using View = typename Accumulator::View;
        const auto is_operation = View(in.get_range_check_sel_lookup_2());
        const auto is_table_entry = View(in.get_main_sel_rng_16());
        return (is_operation + is_table_entry - is_operation * is_table_entry);
    }
    ...
    template <typename AllEntities> static inline auto get_entities(AllEntities&& in)
    {
        return std::forward_as_tuple(in.get_lookup_rng_chk_2_inv(),
                                     in.get_lookup_rng_chk_2_counts(),
                                     in.get_range_check_sel_lookup_2(),
                                     in.get_main_sel_rng_16(),
                                     in.get_range_check_u16_r2(),
                                     in.get_main_clk());
    }
};
...
class lookup_rng_chk_3_lookup_settings {
  public:
    ...
    template <typename AllEntities> static inline auto inverse_polynomial_is_computed_at_row(const AllEntities& in)
    {
        return (in.get_range_check_sel_lookup_3() == 1 || in.get_main_sel_rng_16() == 1);
    }
    ...
    {
        using View = typename Accumulator::View;
        const auto is_operation = View(in.get_range_check_sel_lookup_3());
        const auto is_table_entry = View(in.get_main_sel_rng_16());
        return (is_operation + is_table_entry - is_operation * is_table_entry);
    }
    ...
    template <typename AllEntities> static inline auto get_entities(AllEntities&& in)
    {
        return std::forward_as_tuple(in.get_lookup_rng_chk_3_inv(),
                                     in.get_lookup_rng_chk_3_counts(),
                                     in.get_range_check_sel_lookup_3(),
                                     in.get_main_sel_rng_16(),
                                     in.get_range_check_u16_r3(),
                                     in.get_main_clk());
    }
};
...
class lookup_rng_chk_4_lookup_settings {
  public:
    ...
    template <typename AllEntities> static inline auto inverse_polynomial_is_computed_at_row(const AllEntities& in)
    {
        return (in.get_range_check_sel_lookup_4() == 1 || in.get_main_sel_rng_16() == 1);
    }
    ...
    {
        using View = typename Accumulator::View;
        const auto is_operation = View(in.get_range_check_sel_lookup_4());
        const auto is_table_entry = View(in.get_main_sel_rng_16());
        return (is_operation + is_table_entry - is_operation * is_table_entry);
    }
    ...
    template <typename AllEntities> static inline auto get_entities(AllEntities&& in)
    {
        return std::forward_as_tuple(in.get_lookup_rng_chk_4_inv(),
                                     in.get_lookup_rng_chk_4_counts(),
                                     in.get_range_check_sel_lookup_4(),
                                     in.get_main_sel_rng_16(),
                                     in.get_range_check_u16_r4(),
                                     in.get_main_clk());
    }
};
...
class lookup_rng_chk_5_lookup_settings {
  public:
    ...
    template <typename AllEntities> static inline auto inverse_polynomial_is_computed_at_row(const AllEntities& in)
    {
        return (in.get_range_check_sel_lookup_5() == 1 || in.get_main_sel_rng_16() == 1);
    }
    ...
    {
        using View = typename Accumulator::View;
        const auto is_operation = View(in.get_range_check_sel_lookup_5());
        const auto is_table_entry = View(in.get_main_sel_rng_16());
        return (is_operation + is_table_entry - is_operation * is_table_entry);
    }
    ...
    template <typename AllEntities> static inline auto get_entities(AllEntities&& in)
    {
        return std::forward_as_tuple(in.get_lookup_rng_chk_5_inv(),
                                     in.get_lookup_rng_chk_5_counts(),
                                     in.get_range_check_sel_lookup_5(),
                                     in.get_main_sel_rng_16(),
                                     in.get_range_check_u16_r5(),
                                     in.get_main_clk());
    }
};
...
class lookup_rng_chk_6_lookup_settings {
  public:
    ...
    template <typename AllEntities> static inline auto inverse_polynomial_is_computed_at_row(const AllEntities& in)
    {
        return (in.get_range_check_sel_lookup_6() == 1 || in.get_main_sel_rng_16() == 1);
    }
    ...
    {
        using View = typename Accumulator::View;
        const auto is_operation = View(in.get_range_check_sel_lookup_6());
        const auto is_table_entry = View(in.get_main_sel_rng_16());
        return (is_operation + is_table_entry - is_operation * is_table_entry);
    }
    ...
    template <typename AllEntities> static inline auto get_entities(AllEntities&& in)
    {
        return std::forward_as_tuple(in.get_lookup_rng_chk_6_inv(),
                                     in.get_lookup_rng_chk_6_counts(),
                                     in.get_range_check_sel_lookup_6(),
                                     in.get_main_sel_rng_16(),
                                     in.get_range_check_u16_r6(),
                                     in.get_main_clk());
    }
};
...
class lookup_rng_chk_7_lookup_settings {
  public:
    ...
    template <typename AllEntities> static inline auto get_entities(AllEntities&& in)
    {
        return std::forward_as_tuple(in.get_lookup_rng_chk_7_inv(),
                                     in.get_lookup_rng_chk_7_counts(),
                                     in.get_range_check_sel_rng_chk(),
                                     in.get_main_sel_rng_16(),
                                     in.get_range_check_u16_r7(),
                                     in.get_main_clk());
    }
};
