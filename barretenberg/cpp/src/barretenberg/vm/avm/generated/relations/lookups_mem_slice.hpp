...
class lookup_cd_value_lookup_settings {
  public:
    ...
    {
        return (in.get_slice_sel_cd_cpy() == 1 || in.get_main_sel_calldata() == 1);
    }
    ...
    static inline auto compute_inverse_exists(const AllEntities& in)
    {
        ...
        const auto is_operation = View(in.get_slice_sel_cd_cpy());
        const auto is_table_entry = View(in.get_main_sel_calldata());
    ...
    {
        return std::forward_as_tuple(in.get_lookup_cd_value_inv(),
                                     in.get_lookup_cd_value_counts(),
                                     in.get_slice_sel_cd_cpy(),
                                     in.get_main_sel_calldata(),
                                     in.get_slice_col_offset(),
                                     in.get_slice_val(),
                                     in.get_main_clk(),
                                     in.get_main_calldata());
    }
};
...
class lookup_ret_value_lookup_settings {
  public:
    ...
    template <typename AllEntities> static inline auto inverse_polynomial_is_computed_at_row(const AllEntities& in)
    {
        return (in.get_slice_sel_return() == 1 || in.get_main_sel_returndata() == 1);
    }
    ...
    {
        using View = typename Accumulator::View;
        const auto is_operation = View(in.get_slice_sel_return());
        const auto is_table_entry = View(in.get_main_sel_returndata());
        return (is_operation + is_table_entry - is_operation * is_table_entry);
    }
    ...
    template <typename AllEntities> static inline auto get_entities(AllEntities&& in)
    {
        return std::forward_as_tuple(in.get_lookup_ret_value_inv(),
                                     in.get_lookup_ret_value_counts(),
                                     in.get_slice_sel_return(),
                                     in.get_main_sel_returndata(),
                                     in.get_slice_col_offset(),
                                     in.get_slice_val(),
                                     in.get_main_clk(),
                                     in.get_main_returndata());
    }
};
