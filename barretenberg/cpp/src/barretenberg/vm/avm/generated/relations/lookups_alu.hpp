...
class lookup_pow_2_0_lookup_settings {
  public:
    ...
    {
        return (in.get_alu_sel_shift_which() == 1 || in.get_main_sel_rng_8() == 1);
    }
    ...
    static inline auto compute_inverse_exists(const AllEntities& in)
    {
        ...
        const auto is_operation = View(in.get_alu_sel_shift_which());
    ...
    {
        return std::forward_as_tuple(in.get_lookup_pow_2_0_inv(),
                                     in.get_lookup_pow_2_0_counts(),
                                     in.get_alu_sel_shift_which(),
...
class lookup_pow_2_1_lookup_settings {
  public:
    ...
    template <typename AllEntities> static inline auto get_entities(AllEntities&& in)
    {
        return std::forward_as_tuple(in.get_lookup_pow_2_1_inv(),
                                     in.get_lookup_pow_2_1_counts(),
                                     in.get_alu_sel_shift_which(),
                                     in.get_main_sel_rng_8(),
                                     in.get_alu_max_bits_sub_b_bits(),
                                     in.get_alu_max_bits_sub_b_pow(),
                                     in.get_main_clk(),
                                     in.get_powers_power_of_2());
    }
};
